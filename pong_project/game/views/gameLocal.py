...
class CreateGameLocalView(View):
    ...
    def post(self, request):
        ...
        context = {
			'player_left_name': player_left_name ,# default player 1
			'player_right_name': player_right_name # defaut player 2,
		}

        rendered_html = render_to_string('game/local_game/live_local_game.html', context)
        return JsonResponse({
            'status': 'success',
            'html' : rendered_html,
