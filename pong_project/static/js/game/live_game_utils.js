/* live_game_utils.js
 *
 * Centralise les fonctions communes pour dessiner le canvas, 
 * gérer les power-ups/bumpers, initialiser le WebSocket, etc.
 */
...
import { createPowerupSVG, createBumperSVG } from './live_game_svg.js';
   ...
   *    config.resultsUrl: URL de redirection en cas de fin de partie
   ...
   */
  export function initLiveGame(config) {
    ...
    socket.onmessage = (event) => {
      ...
      if (data.type === 'game_state') {
        ...
        socket.close();
        // Redirection
        window.location.href = config.resultsUrl || '/results';
      }
